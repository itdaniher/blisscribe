...
class IPAVowel(IPALetter):
    ...
    ROUNDNESS = {"unrounded": 1, "rounded": 2, "neither": 3}
    ...
    def compare_openness(self, other):
        ...
        return total - (
            abs(self.get_openness() - other.get_openness()) / total
        )  # /total

    def compare_backness(self, other):
        total = float(len(self.BACKNESS))
        return total - (
            abs(self.get_backness() - other.get_backness()) / total
        )  # /total

    def compare_roundness(self, other):
        total = float(len(self.ROUNDNESS))
        return total - (
            abs(self.get_roundness() - other.get_roundness()) / total
        )  # /total
...
IPACONSONANTS = {
    ...
    u"ɱ": IPAConsonant(
        u"ɱ", "labiodental", "nasal", voiced=True
    ...
    # FLAP/TAP
    u"ⱱ": IPAConsonant(
        u"ⱱ", "labiodental", "flap tap", voiced=True
    ...
    # FRICATIVE
    u"ɸ": IPAConsonant(
        u"ɸ", "bilabial", "fricative", voiced=False
    ),  # vl bilabial fricative
    u"β": IPAConsonant(
        u"β", "bilabial", "fricative", voiced=True
    ),  # vd bilabial fricative
    u"f": IPAConsonant(
        u"f", "labiodental", "fricative", voiced=False
    ),  # vl labiodental fricative
    u"v": IPAConsonant(
        u"v", "labiodental", "fricative", voiced=True
    ),  # vd labiodental fricative
    u"θ": IPAConsonant(
        u"θ", "dental", "fricative", voiced=False
    ),  # vl dental fricative
    u"ð": IPAConsonant(u"ð", "dental", "fricative", voiced=True),  # vd dental fricative
    u"s": IPAConsonant(
        u"s", "alveolar", "fricative", voiced=False
    ),  # vl alveolar fricative
    u"š": IPAConsonant(
        u"š", "alveolar", "fricative", voiced=False
    ),  # vl alveolar fricative
    u"z": IPAConsonant(
        u"z", "alveolar", "fricative", voiced=True
    ),  # vd alveolar fricative
    u"ʃ": IPAConsonant(
        u"ʃ", "post alveolar", "fricative", voiced=False
    ),  # vl postalveolar fricative
    u"ʒ": IPAConsonant(
        u"ʒ", "post alveolar", "fricative", voiced=True
    ),  # vd postalveolar fricative
    u"ʂ": IPAConsonant(
        u"ʂ", "retroflex", "fricative", voiced=False
    ),  # vl retroflex fricative
    u"ʐ": IPAConsonant(
        u"ʐ", "retroflex", "fricative", voiced=True
    ),  # vd retroflex fricative
    u"ç": IPAConsonant(
        u"ç", "palatal", "fricative", voiced=False
    ),  # vl palatal fricative
    u"ʝ": IPAConsonant(
        u"ʝ", "palatal", "fricative", voiced=True
    ...
    u"χ": IPAConsonant(
        u"χ", "uvular", "fricative", voiced=False
    ),  # vl uvular fricative
    u"ʁ": IPAConsonant(u"ʁ", "uvular", "fricative", voiced=True),  # vd uvular fricative
    u"ħ": IPAConsonant(
        u"ħ", "pharyngeal", "fricative", voiced=False
    ),  # vl pharyngeal fricative
    u"ʕ": IPAConsonant(
        u"ʕ", "pharyngeal", "fricative", voiced=True
    ),  # vd pharyngeal fricative
    u"h": IPAConsonant(
        u"h", "glottal", "fricative", voiced=False
    ),  # vl glottal fricative
    u"ɦ": IPAConsonant(
        u"ɦ", "glottal", "fricative", voiced=True
    ),  # vd glottal fricative
    # APPROXIMANT
    # u"w": IPAConsonant(u"w", "bilabial", "approximant", voiced=True),       # vd bilabial approximant
    u"ʋ": IPAConsonant(
        u"ʋ", "labiodental", "approximant", voiced=True
    ),  # vd labiodental approximant
    u"ɹ": IPAConsonant(
        u"ɹ", "post alveolar", "approximant", voiced=True
    ),  # vd (post)alveolar approximant
    u"ɻ": IPAConsonant(
        u"ɻ", "retroflex", "approximant", voiced=True
    ),  # vd retroflex approximant
    u"j": IPAConsonant(
        u"j", "palatal", "approximant", voiced=True
    ),  # vd palatal approximant
    u"ɰ": IPAConsonant(
        u"ɰ", "velar", "approximant", voiced=True
    ),  # vd velar approximant
    # LATERAL FRICATIVE
    u"ɬ": IPAConsonant(
        u"ɬ", "alveolar", "lateral fricative", voiced=False
    ),  # vl alveolar lateral fricative
    u"ɮ": IPAConsonant(
        u"ɮ", "alveolar", "lateral fricative", voiced=True
    ),  # vd alveolar lateral fricative
    u"ɫ": IPAConsonant(
        u"ɫ",
        "alveolar",
        "lateral fricative",  # vd alveolar lateral (velarized) [dark l]
        voiced=True,
        velarized=True,
    ),
    # LATERAL APPROXIMANT
    u"l": IPAConsonant(
        u"l", "alveolar", "lateral approximant", voiced=True
    ),  # vd alveolar lateral approximant
    u"ɭ": IPAConsonant(
        u"ɭ", "retroflex", "lateral approximant", voiced=True
    ),  # vd retroflex lateral approximant
    u"ʟ": IPAConsonant(
        u"ʟ", "velar", "lateral approximant", voiced=True
    ),  # vd velar lateral approximant
    # LATERAL FLAP/TAP
    u"ɺ": IPAConsonant(
        u"ɺ", "alveolar", "lateral flap tap", voiced=True
    ),  # vd alveolar lateral flap
    # ALVEOLOPALATAL
    u"ɕ": IPAConsonant(
        u"ɕ", "alveolopalatal", "fricative", voiced=False
    ),  # vl alveolopalatal fricative
    u"ʑ": IPAConsonant(
        u"ʑ", "alveolopalatal", "fricative", voiced=True
