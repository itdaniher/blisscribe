DERIVATIONS = {
    ...
    "modern": ["newness,novelty", "intensity", "indicator_(description)"],
    "modernism": ["newness,novelty", "intensity"],
    "modernity": ["newness,novelty", "intensity"],
    ...
    "postmodern": ["after,behind", "modern"],
    "postmodernism": ["after,behind", "modernism"],
    ...
    "sexy": ["sexual_intercourse,intercourse,copulation", "indicator_(description)"],
